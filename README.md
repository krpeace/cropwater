...
[![R&D](https://img.shields.io/badge/%EA%B5%AD%EA%B0%80R%26D-RS--2025--02305238-orange)](https://www.nrf.re.kr/)
...
├── tests/
│   ├── test_solar.py
│   └── test_temp.py            ← GDD 계산·도달일자 단위 테스트
│
└── docs/
...
새 작물 추가는 `crops_gdd.csv`에 행 하나를 추가하는 것으로 충분합니다.
